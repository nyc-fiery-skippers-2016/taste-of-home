...
minnesota = List.create!(user_id: "tasteofhome", name: 'Taste of Minnesota', description: "It's the home of warm welcomes and cold winters, of lutefisk and Lizzo, of 10,000 lakes and the late, great Prince. Here's a selection of places where we've found our favorite Minnesota foods in NYC:\nCheese Curds\nSwedish Meatballs\nJuicy Lucy Burger\nWild Rice Soup\nDessert Bars")
...
kiwi = List.create!(user_id: "tasteofhome", name: 'Taste of New Zealand', description: "Most Americans know it as the place where 'Lord of the Rings' was filmed. But New Zealand is far more than a stand-in for Middle Earth. It's one of the world's friendliest, most beautiful, and most unique places, with a cuisine whose fresh flavors combine Maori and British traditions with Mediterranean, Asian, and Australian influences:\nMarmite\nMeat Pie\nMutton chop\nPavlova\nAnzac biscuits")
...
montreal = List.create!(user_id: "tasteofhome", name: 'Taste of Montreal', description: "It's only six hours' drive from New York City, but it's a world away. Montreal is a city of two official languages and many different personalities. Its food reflects its singular, youthful, multicultural atmosphere:\nPoutine\nCoffee Crisp\nMontreal-style bagel\nSmoked meat\nMaple taffy")
...
issan = List.create!(user_id: "tasteofhome", name: 'Taste of Issan', description: "Separated from the rest of Thailand by mountains, the Isan region of Thailand has developed a cuisine all its own that remains distinctive from the central Thai dishes that are generally associated with Thai food in New York City. You won't find pad thai or massaman curry, but you will find strong flavors, fresh ingredients, and lots of sourness and spice:\nLarb\nGreen papaya salad\nIssan sausage\nSticky rice\nGai yang")
...
chicago = List.create!(user_id: "tasteofhome", name: 'Taste of Chicago', description: "It may be the Second City, but, as anyone who has lived there will tell you, it's first in food. Perhaps no American city is more culinarily innovative and has put its own spin on more iconic dishes than the Midwest Metropolis. As generations of Chicagoans have moved across the country and around the world, they have brought their signature foods with them. Even here in New York, where there is a profound difference of opinion about pizza styles and whether ketchup belongs on a hot dog %Q(spoiler alert: it doesn't) Chicagoans can find the foods that they miss most:\nDeep dish pizza\nItalian beef sandwich\nChicago-style hot dog\nJibarito\nMalort")
